<nav class="navbar navbar-expand-lg navbar-light d-flex flex-wrap align-items-center justify-content-between shadow">
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 m-0 navbar-brand">
        <img src="assets/images/merit-logo.png" alt="merit-logo"width="70px"><a href="" class="company">ที่ปรึกษากฎหมายเมริท</a></div>
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
        ...
        <div class="col-lg-auto col-md-4 col-sm-12 col-12 d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-primary">ติดต่อเรา</button>
        </div>
    </div>
</nav>